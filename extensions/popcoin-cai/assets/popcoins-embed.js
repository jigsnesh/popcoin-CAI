...
function load_iframe() {
    ...
    if (window.location.href.indexOf("/products/") != -1) {
        ...
        document.getElementById('popcoinsIframe').src = defaultIframeURL + "&key=" + key + "&page=pdp&discount=" + redeemCoins;
    } else {
        let cartPage = "";
        if (window.location.href.indexOf("/cart") != -1) {
            cartPage = "&page=cart";
        }
        document.getElementById('popcoinsIframe').src = defaultIframeURL + "&key=" + key + cartPage;
    }
